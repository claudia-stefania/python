...
class ChromeSearch:
    ...
    def __init__(self):
        self.chromeDriver = webdriver.Chrome("C:/Users/cparloaga/Documents/chromedriverWin32/chromedriver")
    ...
    def releases(self):
        ...
        allReleasesMenu = chromeDriver.find_element_by_xpath(
            ".//li[@id='downloads']/ul[@class='subnav menu']/li[@class='tier-2 element-1']")
        action.move_to_element(allReleasesMenu).perform()
        allReleasesMenu.click()

        print(chromeDriver.current_url)

        releasesSection = chromeDriver.find_element_by_xpath(
            ".//div[@class='row active-release-list-widget']/ol[@class='list-row-container menu']")
